...
// Fix: Corrected established_date to establishedDate and manual_overrides to manualOverrides to match Partnership and LanguageConfig interfaces
...
// Fix: Corrected p.established_date to p.establishedDate to match Partnership interface
