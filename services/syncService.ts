...
// --- Mappers ---
const mapOrgToDb = (o: Organization) => ({ id: o.id, name: o.name, location: o.location, latitude: o.latitude ?? null, longitude: o.longitude ?? null, founded_year: o.foundedYear, description: o.description, focus: o.focus, is_org_public: o.isOrgPublic, is_species_public: o.isSpeciesPublic, obscure_location: o.obscureLocation, hide_name: o.hideName ?? false, allow_breeding_requests: o.allow_breeding_requests, breeding_request_contact_id: o.breedingRequestContactId || null, show_native_status: o.show_native_status ?? true, dashboard_block: o.dashboard_block || null, is_deleted: o.is_deleted || false });
...
const mapIndToDb = (i: Individual) => ({ 
  ...
  /* Fixed property names from transfer_date/note to transferDate/Note */
...
const mapEventToDb = (e: BreedingEvent) => ({ id: e.id, species_id: e.speciesId, sire_id: e.sireId || null, dam_id: e.damId || null, date: e.date, offspring_count: e.offspring_count, successful_births: e.successful_births, losses: e.losses, notes: e.notes, offspring_ids: e.offspring_ids || [] });
const mapLoanToDb = (l: BreedingLoan) => ({ id: l.id, partner_org_id: l.partnerOrgId, proposer_org_id: l.proposerOrgId, role: l.role, start_date: l.startDate, end_date: l.endDate || null, status: l.status, individual_ids: l.individual_ids || [], terms: l.terms, notification_recipient_id: l.notification_recipient_id || null, change_request: l.change_request || null });
...
const mapLanguageToDb = (l: LanguageConfig) => ({ code: l.code, name: l.name, translations: l.translations, is_default: l.isDefault, manual_overrides: l.manual_overrides || [], is_deleted: l.deleted || false });

// --- Reverse Mappers (DB to App) ---
const fromDbOrg = (o: any): Organization => ({ id: o.id, name: o.name, location: o.location, latitude: o.latitude, longitude: o.longitude, foundedYear: o.founded_year, description: o.description, focus: o.focus, isOrgPublic: o.is_org_public, isSpeciesPublic: o.is_species_public, obscureLocation: o.obscure_location, hideName: o.hide_name, allow_breeding_requests: o.allow_breeding_requests, breedingRequestContactId: o.breeding_request_contact_id, showNativeStatus: o.show_native_status, dashboardBlock: o.dashboard_block, deleted: o.is_deleted });
...
/* Fixed breeding_season_end to breedingSeasonEnd */
