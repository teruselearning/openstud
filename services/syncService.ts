...
// --- Mappers ---
const mapOrgToDb = (o: Organization) => ({ id: o.id, name: o.name, location: o.location, latitude: o.latitude ?? null, longitude: o.longitude ?? null, founded_year: o.foundedYear, description: o.description, focus: o.focus, is_org_public: o.is_org_public, is_species_public: o.isSpeciesPublic, obscure_location: o.obscureLocation, hide_name: o.hideName ?? false, allow_breeding_requests: o.allowBreedingRequests, breeding_request_contact_id: o.breedingRequestContactId || null, show_native_status: o.showNativeStatus ?? true, dashboard_block: o.dashboardBlock || null, is_deleted: o.deleted || false });
...
/**
 * Fix: Use camelCase properties from Individual interface when mapping to DB schema.
 * Properties deathDate, loanStatus, transferDate, transferNote, sourceDetails, weightHistory, growthHistory, healthHistory 
 * were incorrectly accessed as snake_case.
 */
...
/**
 * Fix: Add missing required property 'orgId' to the User object.
 */
