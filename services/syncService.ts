...
const fromDbOrg = (o: any): Organization => ({ 
  ...
  // Fix: property mapping allow_breeding_requests to allowBreedingRequests
...
// Fix: property mapping org_id to orgId
...
// Fix: property mapping start_date, end_date, and notification_recipient_id to camelCase equivalents
...
// Fix: property mapping established_date to establishedDate
...
// Fix: property mapping manual_overrides to manualOverrides
...
// Fix: changed u.org_id to u.orgId
...
// Fix: changed Individual property access to use camelCase (studbookId, birthDate, dnaSequence, sourceDetails, deathDate, transferDate, transferNote, growthHistory, healthHistory)
...
// Fix: changed sireId and damId access from BreedingEvent
...
// Fix: changed establishedDate access from Partnership
