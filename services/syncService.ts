...
// Fix: Corrected plant_classification to map from s.plantClassification
...
// Fix: Corrected transfer related properties to map from camelCase equivalents (transferredToOrgId, transferDate, transferNote)
