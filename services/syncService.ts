...
const fromDbEnclosure = (e: any): Enclosure => ({ id: e.id, orgId: e.org_id, name: e.name, description: e.description, latitude: e.latitude, longitude: e.longitude, speciesIds: safeParse(e.species_ids, []) });
...
export const mapEnclosureToDb = (e: Enclosure) => ({ id: e.id, org_id: e.orgId, name: e.name, description: e.description || null, latitude: e.latitude ?? null, longitude: e.longitude ?? null, species_ids: e.speciesIds || [] });
