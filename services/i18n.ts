...
export const BASE_TRANSLATIONS = {
    ...
    totalSpecies: "Total Taxa",
    totalIndividuals: "Total Specimens",
    endangeredSpecies: "Endangered Taxa",
    ...
    notes: "Notes",
    saveSpecies: "Save Taxon",
    updateSpecies: "Update Taxon",
    ...
    noSpeciesFound: "Your taxonomy list is currently empty.",
    ...
    addFirstSpecies: "Add your first taxon record",
    createFirstEvent: "Record your first breeding event",
    startFirstLoan: "Propose a breeding loan",
    noLocationDataMessage: "Add location data to specimens for them to appear in map view",
    ...
    globalSpeciesCount: "Global Taxa Count",
    ...
    partnerVisibilityPrivate: "Taxonomy list private",
...
export const SEED_LANGUAGES: LanguageConfig[] = [
  {
    ...
    translations: {
      ...
      speciesListVisibilityDesc: "Allow other organisations to see your taxonomy list and population counts.",
